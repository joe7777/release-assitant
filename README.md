...
| --- | --- | --- | --- | --- |
| `project.clone` | Clone un dépôt Git dans un workspace local. | `{"type":"object","properties":{"repoUrl":{"type":"string"},"branch":{"type":"string","nullable":true},"authRef":{"type":"string","nullable":true},"workspaceId":{"type":"string","nullable":true}},"required":["repoUrl"]}` | `{"type":"object","properties":{"workspaceId":{"type":"string"},"repoUrl":{"type":"string"},"branch":{"type":"string"},"commitHash":{"type":"string"},"localPath":{"type":"string"}},"required":["workspaceId","repoUrl","branch","commitHash","localPath"]}` | `authRef` est un token (jamais loggué). |

...
public class ProjectTools {
    ...
    @McpTool(name = "project.clone", description = "Clone un dépôt Git dans un workspace local")
    ...
    @McpTool(name = "project.analyzeMaven", description = "Analyse le pom.xml et les dépendances Maven")
    ...
    @McpTool(name = "project.indexCodeToRag", description = "Indexe le code source dans Qdrant avec embeddings")
    ...
    @McpTool(name = "project.detectSpringScope", description = "Filtre les dépendances Spring")

package com.example.upgrader.core.model.llm;
...
public class LlmAnalysisResult {
    ...
    public static class Effort {
        ...
        private List<EffortByChange> byChange;
        ...
        public List<EffortByChange> getByChange() {
            return byChange;
        }

        public void setByChange(List<EffortByChange> byChange) {
            this.byChange = byChange;
        }
    }

    public static class EffortByChange {

...
public class AnalysisDetailResponse {
    ...
    private Map<String, Integer> effortByChange;
    ...
    public Map<String, Integer> getEffortByChange() {
        return effortByChange;
    }

    public void setEffortByChange(Map<String, Integer> effortByChange) {
        this.effortByChange = effortByChange;
    }
}
